...
The p value for "guy" population came out to be less than 0.05 as well which means we reject the null hypothesis. However, the vaccine has a negative effect on males because receiving the vaccine makes them more susceptible of getting COVID.   
...
colPerc(table1)
```
From the data above, it shows that 70.69 percent of LGBTQ population contracted COVID with the vaccine while 49.17 percent of population did not contract the virus without the vaccine. 
